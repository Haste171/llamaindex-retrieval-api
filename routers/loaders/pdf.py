...
@router.post("/pdf")
async def file(file: UploadFile, namespace: str):
    """
    Loader: https://llamahub.ai/l/file-pymu_pdf
    """
    file_preview_name, file_extension = os.path.splitext(file.filename)
    ...
    return {'message': 'File uploaded successfully', 'filename': file.filename, "namespace": namespace}